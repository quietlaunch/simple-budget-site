DEV_DesignTokensSystem_2.0_20260130  
...
4. No extra color token families (no separate \--brand-_, \--status-_, \--surface-\*, etc.).
...
3. No repository may define additional \--theme-_, \--semantic-_, \--space-_, \--container-_, \--bp-_, \--font-size-_, \--icon-size-\*, or border/radius tokens outside tokens.css.
